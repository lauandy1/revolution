...
public class MD5Util {
    ...
    public static String encodeUTF8(String param) throws UnsupportedEncodingException {
        return URLEncoder.encode(param, UTF_8);
    }

    public static String decodeUTF8(String param) throws UnsupportedEncodingException {
        return URLDecoder.decode(param, UTF_8);
    }
}
